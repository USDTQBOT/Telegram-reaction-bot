...
✍️ To view the emojis I can use, simply type /reactions. To create your own auto reaction bot, head over to: [Auto-Reaction-Bot on GitHub](https://github.com/USDTQBOT/Telegram-reaction-bot).
...
<button class="button githubBtn" onclick="window.location='https://github.com/USDTQBOT/Telegram-reaction-bot'">Open Source 🌱</button>
